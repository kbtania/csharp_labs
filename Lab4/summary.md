...
- Дано цілі числа а, b, c. Визначити, чи належить а множині Z = {3, 4, 5,...,9}∪{b, b+1, b+2,...,c}.
```cs
using System;
...
- Трикутник задається координатами своїх вершин на площині: A(x₁, y₁), B(x₂, y₂), C(x₃, y₃). Визначити, чи є цей трикутник тупокутним.
