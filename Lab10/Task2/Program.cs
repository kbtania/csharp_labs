...
namespace Lab10Task2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Manufacturer m = new Manufacturer("Hyundai Motor Group", dateProductionManufacturer,
                03144653, 100000);
            ...
            Automobile auto = new Automobile("Hyundai", "black", 
                3232, m, s, o, dateProductionCar);
